...
public class Ex03 {
    ...
    public static void main(String[] args) {
        ...
        if (media >= 6) {
            JOptionPane.showMessageDialog(null, "Você tirou nota " + dft.format(media) + " e foi aprovado!");
        }else {
            JOptionPane.showMessageDialog(null, "Você tirou nota " + dft.format(media) + " e foi reprovado!");
        }
    }
}
